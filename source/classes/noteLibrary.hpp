...
public:
    ...
    /* 
     Returns a measure of how original the produced song is. 1 is completely
     original and 0 is identical to the original.
     */
    double originality( std::vector<RealNote *> * song );
